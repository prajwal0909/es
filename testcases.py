...
# Important note:
#
# For server mode, all case_id should start with 'client_'.  All of attack.com, admin@legitimate.com, and victim@victim.com in thos cases will be replaced with the configured value in config.py.
# 
...
test_cases = {
    ...
    "client_a15": { #works on yahoo_web, outlook_web
        "helo": b"attack.com",
        "mailfrom": b"<any@attack.com>",
        "rcptto": b"<victim@victim.com>",
        # "dkim_para": {"d":b"legitimate.com(.attack.com", "s":b"selector", "sign_header": b"From: <ceo@legitimate.com>"},
